...
var BasicProgressSpinner = /** @class */ (function () {
    ...
    BasicProgressSpinner = __decorate([
        core_1.Component({ template: '<mat-progress-spinner></mat-progress-spinner>' })
    ], BasicProgressSpinner);
...
var ProgressSpinnerCustomStrokeWidth = /** @class */ (function () {
    ...
    ProgressSpinnerCustomStrokeWidth = __decorate([
        core_1.Component({ template: '<mat-progress-spinner [strokeWidth]="strokeWidth"></mat-progress-spinner>' })
    ], ProgressSpinnerCustomStrokeWidth);
...
var ProgressSpinnerCustomDiameter = /** @class */ (function () {
    ...
    ProgressSpinnerCustomDiameter = __decorate([
        core_1.Component({ template: '<mat-progress-spinner [diameter]="diameter"></mat-progress-spinner>' })
    ], ProgressSpinnerCustomDiameter);
...
var IndeterminateProgressSpinner = /** @class */ (function () {
    ...
    IndeterminateProgressSpinner = __decorate([
        core_1.Component({ template: '<mat-progress-spinner mode="indeterminate"></mat-progress-spinner>' })
    ], IndeterminateProgressSpinner);
...
var ProgressSpinnerWithValueAndBoundMode = /** @class */ (function () {
    ...
    ProgressSpinnerWithValueAndBoundMode = __decorate([
        core_1.Component({
...
var SpinnerWithColor = /** @class */ (function () {
    ...
    SpinnerWithColor = __decorate([
        core_1.Component({ template: "<mat-spinner [color]=\"color\"></mat-spinner>" })
    ], SpinnerWithColor);
...
var ProgressSpinnerWithColor = /** @class */ (function () {
    ...
    ProgressSpinnerWithColor = __decorate([
        core_1.Component({ template: "<mat-progress-spinner value=\"50\" [color]=\"color\"></mat-progress-spinner>" })
    ], ProgressSpinnerWithColor);
...
var ProgressSpinnerWithStringValues = /** @class */ (function () {
    ...
    ProgressSpinnerWithStringValues = __decorate([
        core_1.Component({
