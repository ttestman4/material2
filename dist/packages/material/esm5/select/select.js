 ...
 * @type {?}
 */
export var SELECT_MULTIPLE_PANEL_PADDING_X = 0;
/**
...
/** @type {?} */
export var _MatSelectMixinBase = mixinDisableRipple(mixinTabIndex(mixinDisabled(mixinErrorState(MatSelectBase))));
/**
